    ...
    <div className="App">
          ...
          <FormControl>
            <Stack spacing={2} direction="row">
              <TextField
                ...
                sx={{ backgroundColor: cyan[50], height: "31px" }}
              />
              {/* <Button
                startIcon={<SearchIcon />}
                sx={{ backgroundColor: cyan[500] }}
      ...
      {/* {inputValue && (
        <div className="styleinput">
          ...
          <Button onClick={() => onClickSearchButton()} variant="contained">
            search
          </Button>
        </div>
      )} */}
